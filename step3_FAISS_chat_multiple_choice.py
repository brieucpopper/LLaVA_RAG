...
question,answer_a,answer_b,answer_c,answer_d,folder_path = 'what is 2+2?','4','5','6','7',args.i


conv,image = return_image_and_enhanced_query(question,answer_a,answer_b,answer_c,answer_d,args.i)
